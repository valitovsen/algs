...
<ul>
  ...
  <li><b>Bellman-Ford Algorithm</b> - DP algorithm to find shortest paths from the source to every other node in a directed weighted graph in <i>O(|E||V|)</i> time  [<a href="bellman.py">code</a>][<a href="https://en.wikipedia.org/wiki/Bellman–Ford_algorithm">wiki</a>]</li>
 </ul>
